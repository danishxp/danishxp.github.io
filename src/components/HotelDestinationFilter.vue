<template>
  <b-container class="single_form single_section" id="availabilityRates">
    <b-row class="mt-5 pb-5 align-items-start">
          <b-col cols="12" xl="7" lg="8" class="pl-0">
            <h2>Availability and Rates</h2>
            <p>
              Please note: The layout, furniture, and decor of your space may
              vary from what's shown here.
            </p>
          <b-form class="card p-2 rounded-pill shadow mt-md-0 mt-4">
          <div class="d-flex flex-wrap justify-content-center justify-content-md-start">
            <b-col cols="6" md="5"
              class="d-flex align-items-center justify-content-center py-2 rounded-left-pill"
              ref="datepickerCol"
            >
              <svg
              ...
              >
                <path
                  d="M477.867,51.2h-59.733V34.133C418.133,15.313,402.825,0,384,0c-18.825,0-34.133,15.313-34.133,34.133V51.2H162.133
                        ...
                        c4.708,0,8.533,3.829,8.533,8.533V153.6z"
                  fill="#f47a55"
                  data-original="#f47a55"
                  class=""
                ></path>
                <path
                  d="M395.033,372.967c1.667,1.667,3.85,2.5,6.033,2.5c2.183,0,4.367-0.833,6.033-2.5l68.267-68.267
                        c3.333-3.333,3.333-8.733,0-12.067c-3.333-3.333-8.733-3.333-12.067,0l-62.233,62.233l-28.1-28.1
                        c-3.333-3.333-8.733-3.333-12.067,0c-3.333,3.333-3.333,8.733,0,12.067L395.033,372.967z"
                  fill="#f47a55"
                  data-original="#f47a55"
                  class=""
                ></path>
              ...
              <div class="ml-3 date-availability w-100 position-relative">
                <div
                  class="position-absolute date-placeholder fs-6 "
                  ref="datePlaceholder"
                >
                ...
                <date-range-picker
                  ...
                  @toggle="hideShow($event)"
                >
                  <div class="drp-buttons" slot="footer" slot-scope="data">
                    <span class="drp-selected"> {{ data.rangeText }} </span>
                    <button
                      type="button"
                      class="border-0 lh-1 ml-3 px-4 py-2 rounded-pill text-white btn-secondary"
                      @click="pickerUpdate(data)"
                    >
                      Cancel
                    </button>
                    <button
                      type="button"
                      class="border-0 btn-info lh-1 ml-3 px-4 py-2 rounded-pill text-white"
            ...
            <b-col cols="6" md="4"
              class="form-guest d-flex justify-content-center py-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                version="1.1"
              ...
              >
                <path
                  d="M244.587,241.557c32.128-18.389,54.08-52.629,54.08-92.224c0-58.816-47.851-106.667-106.667-106.667
                ...
                ></path>
                <path
                  d="M388.224,241.835c23.125-15.296,38.443-41.451,38.443-71.168c0-47.061-38.272-85.333-85.333-85.333
              ...
              <!-- icon -->
              <div class="mt-1">
                <div class="ml-3 align-items-center d-flex fs-6">
                  ...
                  <b-form-spinbutton
                    ...
                    min="1"
                    max="10"
                    class="border-0 text-gray p-0 w-100 ml-3"
                  ></b-form-spinbutton>
                </div>
              </div>
            </b-col>

            <b-col class="my-auto pr-2" cols="6" md="3">
              <b-button
                pill
                variant="info"
                class="text-white lh-1 py-3 poppins_semi_bold w-100"
                >Price</b-button
              >
            </b-col>
          </div>
          ...
          <b-col cols="12" lg="4" md="8" offset-xl="1" class="book-bg-color p-4 book-now mt-xl-2 mt-5">
            <div class="">
              <span class="font-weight-bold"> Book with peace of mind </span
              ><span
                >Cancel your reservation up to 3 days before check-in for a full
                refund
              </span>
            </div>
          </b-col>
  ...
  data() {
    return {
      ...
      options: [
          ...
          { id: 'bristol', text: 'Bristol' },
          { id: 'leicester', text: 'Leicester' },
